...
const getAdmin = ()=>{
    ...
    .then(res => res.json())
    .then(data => {console.log('esto es get admin', data)

        let datos = document.getElementById('contTabla') as HTMLElement 
...
const getCarrito = ()=>{
    ...
    let datos = document.getElementById('carrito') as HTMLElement 
